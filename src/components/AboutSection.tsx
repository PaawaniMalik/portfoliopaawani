...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="min-h-screen bg-card py-20 px-4 md:px-8 relative overflow-hidden">
      {/* Decorative starbursts */}
      <Starburst className="top-20 right-10 opacity-50" size="sm" />
      <Starburst className="bottom-32 left-10 opacity-50" size="md" />
